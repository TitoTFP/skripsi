...
def main() -> None:
    ...
    train_dataset = FloodTileDataset("train", architecture=args.architecture, root=args.tile_root)
    val_dataset = FloodTileDataset("val", architecture=args.architecture, root=args.tile_root, augment=False)
